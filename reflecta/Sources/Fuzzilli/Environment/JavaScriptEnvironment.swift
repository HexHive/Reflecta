...
public class JavaScriptEnvironment: ComponentBase, Environment {
    ...
    // TODO more?
    public var interestingStrings = jsTypeNames
    ...
    public var customProperties = Set<String>(["a", "b", "c", "d", "e", "f", "g", "h"])
    public var customMethods = Set<String>(["m", "n", "o", "p", "valueOf", "toString"])
    public var builtinProperties = Set<String>()
    public var builtinMethods = Set<String>()
